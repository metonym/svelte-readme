...
## [4.5.2](https://github.com/metonym/svelte-readme/releases/tag/v4.5.2) - 2026-07-05

- improve table, inline code snippet styles

## [4.5.1](https://github.com/metonym/svelte-readme/releases/tag/v4.5.1) - 2026-07-05

- don't shadow IntersectionObserver constructor
...
- revise button styles, TOC gap

## [4.3.0](https://github.com/metonym/svelte-readme/releases/tag/v4.3.0) - 2026-07-04

- support `HIDE_START/HIDE_END` hide comments
- further typography tweaks
- add scroll gradients for overflowing tables
- convert highlight CSS to CSS variables

## [4.2.0](https://github.com/metonym/svelte-readme/releases/tag/v4.2.0) - 2026-07-04

- add copy button to code blocks
- support dark mode
- polish typography, colors, and spacing

## [4.1.0](https://github.com/metonym/svelte-readme/releases/tag/v4.1.0) - 2026-07-04

- rework page styles and table of contents design

## [4.0.1](https://github.com/metonym/svelte-readme/releases/tag/v4.0.1) - 2026-07-04

- preserve class: directive class names during collision renaming

## [4.0.0](https://github.com/metonym/svelte-readme/releases/tag/v4.0.0) - 2026-07-04

- convert `svelteReadme` to Vite plugin, ESM-only package
